	...
	setInterval(() => {
		...
		if (gs == 4) {
			...
			if (star1 == 0 && sstar1 == 0) {
				...
				let sZ = Math.random()*100;
				sstar1 = 1;
				star1 = 1;
				
				if (sstar1 == 1) {
					$('#star1').css('left', "760px");
					$('#star1').css('top', sTop1+"%");
					$('#star1').css('width', sSize1);
					$('#star1').css('height', sSize1);
					$('#star1').css('z-index', sZ);
					setTimeout(() => {
	...
	setInterval(() => {
		...
		if (gs == 4) {
			...
			if (star39 == 0 && sstar39 == 0) {
				let sSize1 = Math.random()*150 + 20;
				let sSpeed1 = Math.random()*15 + 3;
				let sTop1 = Math.random()*100;
				let sZ = Math.random()*100;
				sstar39 = 1;
				star39 = 1;
	...
	setInterval(() => {
		...
		if (gs == 4) {
			...
			if (star40 == 0 && sstar40 == 0) {
				let sSize1 = Math.random()*250 + 50;
				let sSpeed1 = Math.random()*30 + 10;
				let sTop1 = Math.random()*100;
				let sZ = Math.random()*100;
				sstar40 = 1;
				star40 = 1;
